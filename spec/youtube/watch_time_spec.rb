...
RSpec.describe "Youtube::WatchTime" do
  ...
  context "count" do
    ...
    it "ordered_most_watched" do
      ...
      result = [
          {id: "https://www.youtube.com/watch?v=DRhGVZTVTco", title: 'v6.0: Minha História, do "mato" ao sucesso na TI', watch_time: 166.5},
          {id: "https://www.youtube.com/watch?v=1OaRT7heJ58", title: 'v10.4: Como configurar o Php para estudar?', watch_time: 0.0}
      ]
